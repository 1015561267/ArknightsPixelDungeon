...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			text.setText("Arknights Pixel Dungeon cannot start because some of its code is missing!\n\n" +
			...
			text.setTypeface(Typeface.createFromAsset(getAssets(), "miscs/fonts/pixel_font.ttf"));
