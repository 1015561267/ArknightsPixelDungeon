...
import com.unifier.arknightspixeldungeon.sprites.TenguSprite;
...
public class Tengu extends Mob {
	...
	public void notice() {
		...
		if (HP == HT) {
			yell(Messages.get(this, "notice_mine", Dungeon.hero.operatorName()));
		} else {
			yell(Messages.get(this, "notice_face", Dungeon.hero.operatorName()));
		}
	}
