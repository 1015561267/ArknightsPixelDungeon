...
import com.unifier.arknightspixeldungeon.actors.buffs.Berserk;
...
import com.unifier.arknightspixeldungeon.items.Heap.Type;
...
import com.unifier.arknightspixeldungeon.items.keys.CrystalKey;
...
public class Hero extends Char {
	...
	public HeroSkill skill_1;
    public HeroSkill skill_2;
    public HeroSkill skill_3;
...
//		HP = HT = 2000;
	...
	public void storeInBundle( Bundle bundle ) {
		...
		HeroSkill.storeSkillsInBundle(bundle,this);
	...
	public void restoreFromBundle( Bundle bundle ) {
        ...
        HeroSkill.restoreSkillsFromBundle(bundle,this);
    ...
    public boolean reachTalentThresholds(Talent talent)
    {
        return lvl <= Talent.tierLevelThresholds[talent.tier];
    }

    public int talentAllPossible(int tier){
       switch (tier)
       {
           default:return 0;
           case 1:return 6;
