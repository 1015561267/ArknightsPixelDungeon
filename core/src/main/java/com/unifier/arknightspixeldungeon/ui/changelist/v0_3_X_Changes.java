...
public class v0_3_X_Changes {
	...
	public static void add_v0_3_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.WARRIOR, 0, 0, 13, 17), "Warrior Rework!",
				"Warrior Rework:\n" +
		...
		changes.addButton( new ChangeButton(new Image(Assets.WARRIOR, 0, 0, 13, 17), "Warrior Subclass Rework!",
				"Berserker Rework:\n" +
	...
	public static void add_v0_3_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.LANGUAGE), "Translations!",
	...
	public static void add_v0_3_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.SETTINGS), "Google Play Games",
	...
	public static void add_v0_3_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.TENGU, 0, 0, 16, 16), "Prison Rework",
	...
	public static void add_v0_3_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.MAGE, 0, 0, 13, 17), "Mage Rework!",
