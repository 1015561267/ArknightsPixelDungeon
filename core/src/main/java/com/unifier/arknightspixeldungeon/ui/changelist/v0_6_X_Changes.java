...
import com.unifier.arknightspixeldungeon.items.armor.curses.Bulk;
...
import com.unifier.arknightspixeldungeon.items.stones.StoneOfEnchantment;
...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.WARRIOR, 0, 0, 13, 17), "Berserker",
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.SETTINGS), Messages.get(ChangesScene.class, "misc"),
		...
		changes.addButton( new ChangeButton(new Image(Assets.SPINNER, 161, 2, 14, 12), Messages.get(ChangesScene.class, "bugfixes"),
				"Fixed:\n" +
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.LANGUAGE), Messages.get(ChangesScene.class, "language"),
		...
		changes.addButton( new ChangeButton(new Image(Assets.MAGE, 0, 0, 13, 17), "Warlock",
		...
		changes.addButton( new ChangeButton( new Image(Assets.HUNTRESS, 0, 0, 13, 17), "Huntress",
	...
	public static void add_v0_6_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		Image tempChasm = new Image(Assets.TILES_SEWERS, 96, 96, 32, 32);
		tempChasm.scale.x *=0.5f;
		tempChasm.scale.y *=0.5f;//FIXME it is super stupid to do this due to the doubled resolution,there should be a better way
		changes.addButton( new ChangeButton(tempChasm, "Chasm changes",
	...
	public static void add_v0_6_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new Image(Assets.ROGUE, 0, 0, 13, 17), "Rogue Rework!",
		...
		changes.addButton( new ChangeButton( new Image(Assets.ROGUE, 0, 0, 13, 17), "Rogue Subclasses Rework!",
