...
public class v0_2_X_Changes {
	...
	public static void add_v0_2_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.STONE_KAUNAN, null), "Pixel Dungeon v1.7.2",
	...
	public static void add_v0_2_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.GHOST, 1, 0, 11, 16), "New Sewer Quests",
		...
		changes.addButton( new ChangeButton(new Image(Assets.GOO, 0, 0, 12, 16), "Goo Changes",
