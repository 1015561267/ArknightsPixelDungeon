...
package com.unifier.arknightspixeldungeon.messages;

import java.util.Locale;

public enum Languages {

    //It's unavoidable that language things become unusable because of text changing,it might be added again someday
