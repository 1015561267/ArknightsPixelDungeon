...
public class HotSpringBuskerSprite extends MobSprite {

    public HotSpringBuskerSprite() {
        super();

        texture( Assets.HOTSPRINGBUSKER );

        TextureFilm frames = new TextureFilm( texture, 32,  PDSettings.flyingSheep() ? 32 : 30 );
